...
class FavoritesState extends State<Favorites> {
  ...
  getChapters() async {
    final chapterData = await DatabaseHelper.db.getChapters();
    return chapterData;
  }
  ...
  getMangas() async {
    final mangaData = await DatabaseHelper.db.getMangas();
    return mangaData;
  }
  ...
  Future<void> refreshManga() async {
    final mangaData = await DatabaseHelper.db.getMangas();
    setState(() {
      _mangaFuture = Future.value(mangaData);
    });
  }

...
class MangaInfo extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => MangaInfoState(manga);
}
...
class MangaInfoState extends State<MangaInfo>
  ...
  getMangaBytitle() async {
    final mangaData = await DatabaseHelper.db.getMangaByTitle(manga.title);
    return mangaData;
  }
        ...
        builder: (_, AsyncSnapshot<MangaInfoModule> snapshot) {
          if (snapshot.data == null) {
            ...
            return (() {
              ...
              final appBarHeight = parentHeight / 3.5;
              final thumbHeight = appBarHeight / 2.5;
